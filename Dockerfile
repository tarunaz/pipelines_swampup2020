...
ARG REGISTRY=https://artifactory-unified.soleng-us.jfrog.team/artifactory
MAINTAINER Shani Levy

# Download artifacts from Artifactory
RUN curl tarunm:AKCp8jQTfUNGeKVbAax8tgZUTmJE5nU1kaqj6HdWoiCYR2ASoL9HatYFkijAenFLRMzjCz3fg $REGISTRY/libs-release-local/com/jfrog/backend/1.0.0/backend-1.0.0.jar --output server1.jar
RUN curl tarunm:AKCp8jQTfUNGeKVbAax8tgZUTmJE5nU1kaqj6HdWoiCYR2ASoL9HatYFkijAenFLRMzjCz3fg $REGISTRY/npm-dev-local/frontend/-/frontend-3.0.0.tgz --output client1.tgz
